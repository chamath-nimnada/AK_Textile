...
namespace AK_Textile
{
    public partial class EmpManagerDepartmentAdd : Form
    {
        ...
        private void EmpManagerDepartmentAdd_Load(object sender, EventArgs e)
        {
            ...
            if (dr1.Read())
            {
                ...
                else
                {
                    ...
                    string newID = "D" + (numericPart + 1).ToString("D3"); // Increment and format as "DXXX"
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                this.errorProvider1.SetError(this.depnametxt, "Department name cannot be empty");
                return;
            }
            else if (this.loctxt.Text == "")
            {
                this.errorProvider1.SetError(this.loctxt, "Location cannot be empty");
                return;
            }
            con.Open();
            ...
            cmd2.Parameters.AddWithValue("@dloc", loctxt.Text);
